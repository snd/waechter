...
(function(root, factory) {
  ...
  waechter.maybe = function(validator) {
    return function(value) {
  ...
  waechter.string = waechter.all(waechter.exist, waechter.predicateToValidator(isjs.string, function() {
    return waechter.errors.string;
  }));
  waechter.errors.string = 'must be a string';
  waechter.stringNotEmpty = waechter.all(waechter.string, waechter.predicateToValidator(isjs.not.empty, function() {
    return waechter.errors.stringNotEmpty;
  }));
  waechter.errors.stringNotEmpty = 'must not be empty';
  waechter.email = waechter.all(waechter.string, waechter.predicateToValidator(isjs.email, function() {
  ...
  waechter.stringMinLength = function(min) {
    ...
    return waechter.all(waechter.stringNotEmpty, waechter.predicateToValidator(predicate, function() {
